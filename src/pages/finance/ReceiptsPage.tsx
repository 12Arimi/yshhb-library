            ...
            <tbody>
              {receipts.map((r) => (
                <tr key={r.id} className="border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                  ...
                  <td className="px-5 py-3 text-right text-foreground">BND. {r.amount.toLocaleString()}</td>
          ...
          <div className="bg-background border border-border rounded-lg max-w-md w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="border-t border-border pt-4 flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-foreground">BND. {previewReceipt.amount.toLocaleString()}</span>
              </div>
