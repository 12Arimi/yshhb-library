...
export default function RegistrarLayout() {
  ...
  return (
    <div className="min-h-screen bg-secondary relative overflow-hidden">
      ...
      {/* Main Content Area */}
      <main className="relative z-10 pt-[6.5rem] md:pt-[7.5rem] pb-24 md:pb-10 p-6 sm:px-12 max-w-7xl w-full mx-auto">
        <Outlet />
      </main>
