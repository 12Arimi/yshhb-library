...
import { BookOpen, DollarSign, ClipboardList, GraduationCap } from "lucide-react";
...
const modules = [
  ...
  { label: "Registrar", description: "Student records and enrollment", icon: ClipboardList, path: "#" },
